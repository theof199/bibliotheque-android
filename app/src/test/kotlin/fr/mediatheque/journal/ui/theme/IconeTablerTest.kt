...
class IconeTablerTest {
    ...
    // Les dix icônes qui remplacent Icons.* (Material), les trois qui remplacent les
    ...
    fun `chaque icone listee a une ressource`() {
        val noms = listOf(
            "arrow-left", "search", "check", "x", "plus", "chevron-right", "map", "user", "movie",
            "trash", "ticket", "cloud", "star-filled", "sparkles", "award",
