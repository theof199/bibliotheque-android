...
SeanceEtats.kt         nouveau (21 septembre 2026, « la séance », filtre introuvable et
                       ...
                       complété le même jour encore) : CandidatSeance (Film ou Bobine) et
                       ...
                       la plus récente) ; EtatZoneSeance et etatZoneSeance (bouton/en
                       cours/carte proposée/carte prise — `ignoree` rend aussi le bouton,
                       « ignorer » n'étant pas terminal) ; etiquetteEtatSeanceFilm
                       (toujours un texte, y compris « à demander »)
