...
les a repris le lendemain (ci-dessous).
...
| `FiletOr` | `ui/theme/Ornements.kt` | Le filet sous un en-tête : 1 dp `secondary` à 55 %, marges de 16, 8 dp sous le titre. Mes films, Suivis, la fiche d'une saga. |
...
| `lisereOr` | `ui/Cover.kt` | Le liseré des affiches en `Modifier` : 1 dp `secondary` à 22 % (alpha réglable), coins de la forme donnée (8, ou 6 dans la bande d'un cycle). Mes films, l'« Ensuite » d'une carte, la bande, la fiche d'une saga, la grille du pavillon. |
| `SceauRetrospective` | `ui/suivis/SceauRetrospective.kt` (sorti de `RealisateurScreen.kt`) | Le sceau de la rétrospective complète, à la taille voulue : 30 dp animé sur le pavillon, 22 dp statique sur une carte bouclée. |
