...
| **Séance prise / ignorée** (21 septembre 2026, ignorer corrigé le même jour : ce n'est pas terminal) | Prise : la carte reste, étiquetée « Prise », avec les actions par film (Plex, Demander, Je l'ai vu) à la place des quatre boutons, quel que soit l'état de son long par ailleurs. Ignorée : la carte disparaît et le bouton « Composer une séance » revient aussitôt, comme s'il n'y avait pas de séance. L'une comme l'autre rejoint « Séances passées » dès qu'une composition plus récente existe. |
...
VoyageEtats.kt        StatutAnneeVoyage (ouverte/en_cours/verrouillee), VoyageUi (porte
                       ...
                       d'etatParagrapheSuivant, plafond de l'année)
SeanceEtats.kt         nouveau (21 septembre 2026, « la séance », filtre introuvable et
                       etatZoneSeance corrigés le même jour) : CandidatSeance (Film ou
                       Bobine) et GroupeCandidatsSeance, candidatsSeanceLong (films sans
                       programme, jamais vus ni introuvables) et candidatsSeanceCourt
                       (programmes et bobines non vus ni introuvables, chacun sur son
                       propre état — même filtre que le long, le back refuse un
                       introuvable en 400 dans les deux cas), groupés par salle et triés
                       Plex/demandé/à demander ; corpsRemplacementSeance (film_id seul, +
                       bobine_tmdb_id pour une bobine) ; seanceRecente et seancesPassees
                       (rang décroissant, jamais la plus récente) ; EtatZoneSeance et
                       etatZoneSeance (bouton/en cours/carte proposée/carte prise —
                       `ignoree` rend aussi le bouton, « ignorer » n'étant pas terminal) ;
                       etiquetteEtatSeanceFilm (toujours un texte, y compris « à
                       demander »)
...
AnneeViewModel.kt     réécrit le 21 septembre 2026 : les salles d'une année (GET
                       ...
                       retombe, jumeau de voirPlus), prendreSeance/ignorerSeance/
                       remplacerSeance (relireApresSeance, jumeau de relireApresPodium),
                       demander met aussi à jour le film de la séance en cours si son
                       tmdb_id correspond (mettreAJourSeanceFilm)
