...
| **Voyage** (brief du 15 septembre 2026 « la Frise », devenu le calendrier du siècle le 16, puis **la carte** le même jour) | Quatrième entrée de la `NavigationBar` du bas, entre « Accueil » et « Suivis » — icône `Timeline`, `contentDescription` « Frise » ; sélectionnée sur cet écran. En tête, le HUD (fixe, hors défilement) : « Chapitre I · Les origines » (`titleLarge`, dans l'accent du monde en cours, le numéro en chiffres romains), puis « 3 années faites · 1898 en cours » et le compte des récompenses (« 3 Palmes · 1 Lion »), tous deux en `bodyMedium onSurfaceVariant`. Puis la carte, dans une `LazyColumn` : une **pellicule** dessinée au `Canvas` serpente du haut vers le bas (deux courbes quadratiques par cellule, largeur 40 dp, perforations posées à la normale de la courbe sur les deux bords), et porte **un photogramme par année** (54 × 40 dp) — année faite : l'affiche du dernier film vu de l'année, liseré doré `#E6B94A` et le glyphe de sa récompense dessous ; année en cours : le même photogramme sous un cône de lumière corail (dégradé radial) avec « Tu es ici · 2/5 » et le **clap de l'icône** à côté ; année verrouillée : un cadre noir au liseré gris pointillé portant le millésime, sous-titré « à tourner », ou « 1 vu en avance » si le journal y a déjà un film. Toucher un photogramme ouvre `Screen.Annee`. À l'ouverture, la liste défile jusqu'à l'année en cours. Les années sont groupées par **monde** (une décennie, §2) : le monde donne le fond de sa section, son motif, et un titre en tête (lettrine en `displaySmall`, « 1890 · LES ORIGINES » en `titleMedium` espacé, le sous-titre en `bodyMedium onSurfaceVariant`). Au bout de chaque monde, sa **marquise** de cinéma (`Canvas` : un bloc, un auvent en trapèze, neuf ampoules le long de l'auvent) — ampoules éteintes (`outline`) tant que la décennie n'est pas bouclée, allumées une à une en 1,5 s au moment où elle l'est, d'un coup si elle l'était déjà ; le nom de la décennie, et le titre de voyageur en lettres or quand elle est bouclée, « en cours de tournage » sinon. Toucher la marquise ouvre `Screen.Decennie`. En bas, fixe au-dessus de la barre de navigation, la carte **« Prochaine étape »** (`surfaceContainer`) : le premier essentiel de l'année en cours qui n'est ni vu ni introuvable — affiche 40 × 60, « Prochaine étape » en `labelSmall`, le titre en `titleMedium`, le réalisateur et l'année dessous — avec un `TextButton` « Voir » (formulaire pré-rempli) s'il est sur le Plex, « Demander sur Sir » sinon, qui devient « demandé ». Absente s'il n'y a rien à voir. **Les récompenses** remplacent les étoiles de la phase 1 : une année faite vaut la Palme (tous les essentiels vus), le Lion (un ou deux introuvables), l'Ours (au-delà) — trois glyphes vectoriels (feuille, crinière de lion, ours) dessinés au `Canvas`. La frontière qui avance fait claquer le clap et affiche « 1898 dans la boîte ! · Palme » en snackbar ; une décennie bouclée allume sa marquise et ouvre `Screen.Generique`. |
...
| **Année** (brief du 15 septembre 2026, augmentée du Voyage le 16) | Empilé depuis la Frise, sans barre du bas : une barre de titre avec retour et l'année (ou « Sans année »). **La palette du monde** (§2, phase 2) : le fond de l'écran est celui de la décennie, et son nom s'affiche sous le millésime. **Le cartouche du Voyage**, kitsch : papier jauni (`#F2E8D5`) par-dessus, cadre ornementé simple, l'année en `titleLarge`, et le glyphe de sa récompense (Palme, Lion, Ours) à côté du millésime sur une année faite — l'étoile de la phase 1 a disparu. Il porte le récit et les faits d'une chronique déjà prête, ou « Le chroniqueur écrit… ça prend une minute ou deux » (indicateur circulaire) tant qu'elle est en préparation — relue toutes les cinq secondes, **trente-six fois au plus** (trois minutes, `GET /reference/chroniques/annees/{annee}`), et la relecture repart à chaque entrée sur la page. Sur une année **verrouillée**, il laisse place au carton **« Prochainement »** façon bande-annonce : un cadre de 2 dp dans l'accent du monde, « PROCHAINEMENT » en `titleLarge` espacé, les affiches des essentiels **floutées** (12 dp) et voilées quand le back en donne un aperçu (`essentiels_apercu`, optionnel — rien ne s'affiche tant qu'il ne le sert pas), et « *N* essentiels t'attendent · *M* vus en avance ». Puis, si la chronique en porte, « Les essentiels » : une ligne par film (affiche 40×60, rang, titre, réalisateur, le « pourquoi ») et son état à droite — vu (la note), sur le Plex (pastille « sur ton Plex », toucher ouvre le formulaire pré-rempli), à trouver (`TextButton` « Demander sur Sir » → `POST /me/voyage/demander/{tmdbId}`, puis pastille « demandé »), introuvable (grisée, la mention). Un appui long sur un essentiel non vu ouvre le même `ModalBottomSheet` « Marquer introuvable » / « Le remettre à voir » que la fiche d'un réalisateur (`PUT`/`DELETE /me/introuvables/{tmdbId}`, existants). Puis la grille des films vus cette année, mêmes tuiles que l'accueil (note en pastille, toucher ouvre la correction). Puis, si elle n'est pas vide, « À voir sur le Plex » (`titleMedium`) et la même grille pour les films pas encore vus — même affiche, un liseré pointillé `onSurfaceVariant` à la place de la note, jamais de coche ; toucher ouvre le formulaire pré-rempli, comme depuis « Au ciné ». |
...
| **Le chroniqueur écrit** (brief du 16 septembre 2026) — chronique d'année ou carton de film | Un indicateur circulaire de 16 dp et « Le chroniqueur écrit… » (année) ou « Le chroniqueur arrive… » (film), dans le cartouche kitsch, tant que `statut` reste `en_preparation`. Relu toutes les cinq secondes (année) ou trois secondes (film), dix fois au plus ; au-delà, abandon silencieux — « Il sera dans la fiche du film » pour le carton, rien de plus pour la chronique d'année (le cartouche reste affiché, sans texte). |
| **Le chroniqueur écrit**, chronique d'année (revu le 16 septembre 2026, phase 2) | « Le chroniqueur écrit… ça prend une minute ou deux », relue toutes les cinq secondes **trente-six fois** (trois minutes) au lieu de dix ; la relecture repart à chaque entrée sur la page, un abandon n'étant plus définitif. Le carton d'un film, lui, garde ses dix essais de trois secondes. |
| **Année verrouillée** (brief du 16 septembre 2026, phase 2) | Le carton « Prochainement » : les affiches floutées quand le back en donne un aperçu, « *N* essentiels t'attendent · *M* vus en avance » sinon, et « Cette année n'est pas encore ouverte » quand le Voyage ne sait rien d'elle. Jamais un cadre vide en guise d'aperçu. |
| **Décennie non bouclée** (brief du 16 septembre 2026, phase 2) | Sur sa marquise : ampoules éteintes (`outline`) et « en cours de tournage » à la place du titre de voyageur. |
| **Année bouclée** (brief du 16 septembre 2026, phase 2) | Le clap claque sur la carte et « 1898 dans la boîte ! · Palme » en snackbar, deux secondes comme les autres. Une décennie bouclée y ajoute l'allumage de la marquise (1,5 s) puis le générique de fin. |
...
VoyageEtats.kt      les statuts d'une année, VoyageUi, l'état d'une chronique et ses
                     deux plafonds de relecture (10 pour un film, 36 pour une année)
VoyageCarte.kt      les règles pures de la carte : recompense (Palme/Lion/Ours),
                     prochaineEtape, detecterFrontiereAvancee, tamponsPasseport
...
VoyageScreen.kt     l'écran de l'onglet « Frise » : le HUD, la carte mise à plat en
                     cellules, les marquises, la carte « Prochaine étape »
...
AnneeScreen.kt      la page d'une année, cartouche et carton « Prochainement »
...
AnneeViewModel.kt   la chronique d'une année, relue à chaque entrée
```
...
photogrammes portent une affiche.
