...
| **Séance prise / ignorée** (21 septembre 2026) | Prise : la carte reste, étiquetée « Prise », avec les actions par film (Plex, Demander, Je l'ai vu) à la place des quatre boutons. Ignorée : la carte disparaît (aucun remplaçant tant qu'aucune nouvelle composition n'est demandée) ; l'une comme l'autre rejoint « Séances passées » dès qu'une composition plus récente existe. |
...
SeanceEtats.kt         nouveau (21 septembre 2026, « la séance ») : CandidatSeance (Film
                       ou Bobine) et GroupeCandidatsSeance, candidatsSeanceLong (films
                       sans programme, jamais vus ni introuvables) et candidatsSeanceCourt
                       (programmes et bobines non vus — jamais filtrés sur introuvable,
                       à la différence du long, décision du propriétaire), groupés par
                       salle et triés Plex/demandé/à demander ; corpsRemplacementSeance
                       (film_id seul, + bobine_tmdb_id pour une bobine) ; seanceRecente et
                       seancesPassees (rang décroissant, jamais la plus récente) ;
                       EtatZoneSeance et etatZoneSeance (bouton/en cours/carte
                       proposée/carte prise/rien) ; etiquetteEtatSeanceFilm (toujours un
                       texte, y compris « à demander »)
