...
| **Le chroniqueur écrit** — carton de film (pop-in depuis le brief du 24 septembre 2026, « le voyage revu », décision 4) | Dans la `FeuilleDeLecture` du carton — après un enregistrement (le clap joué), ou depuis « Le film » sur une fiche — une bobine Lottie tant que `statut` reste `en_preparation`. Relu toutes les trois secondes, dix fois au plus ; au-delà, un message d'abandon sans bouton « Réessayer », la feuille restant fermable à tout moment. |
...
9. **Fin d'un film** (`FilmEnregistreCalque`, `ui/celebrations/`) : le clap de l'icône, redessiné en
   ...
   sur un tap, indépendante de la feuille, fermable elle-même à tout moment. *Écart
