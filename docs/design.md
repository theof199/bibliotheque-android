...
| **Accueil** | Un `Button` plein « Ajouter un film », centré verticalement, pleine largeur. Un `IconButton` profil en haut à droite, icône de personne en `onSurface`, cible 48 dp. Rien d'autre sur l'écran, et le noir autour n'est pas un vide à combler. |
