...
VoyageEtats.kt        StatutAnneeVoyage (ouverte/en_cours/verrouillee), VoyageUi (porte
                       désormais ticketAMontrer), l'état d'une chronique (EtatChronique)
                       ...
                       EtatZoneSalleVoyage (bouton/fantôme/refus)
VoyageCarte.kt        afficheAnnee (21 septembre 2026, « le podium » — affiche_url avant
                       le dernier vu), et les règles pures qui restent : recompense
                       (Palme/Lion/Ours), phraseRecompenses, detecterFrontiereAvancee,
                       tamponsPasseport — ces trois-là n'ont encore de quoi produire un
                       résultat non vide qu'aux étapes 3 et 5 de la spec ; le ticket (21
                       septembre 2026) : TicketPortefeuilleUi, trierPortefeuille (non
                       utilisés d'abord, compostés par date ensuite)
...
VoyageScreen.kt       l'écran de l'onglet « Frise » : le HUD, la carte mise à plat en
                       ...
                       prend afficheAnnee (21 septembre 2026)
...
AnneeScreen.kt        réécrit le 21 septembre 2026 : la page d'une année — cartouche
                       ...
                       NouvelleSalleSheet) sous la dernière étagère
...
AnneeViewModel.kt     réécrit le 21 septembre 2026 : les salles d'une année (GET
                       ...
                       un refus vu une seule fois, par identifiant)
ChroniqueViewModel.kt nouveau (21 septembre 2026, « la chronique et les salles ») : jumeau
                       ...
                       (ui/form/FormScreen.kt), sans charger l'année entière
```

**Le portefeuille**, sous `app/src/main/kotlin/fr/mediatheque/journal/ui/profile/` (décision 3 du
