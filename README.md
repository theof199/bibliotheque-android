...
- [ ] « Au ciné » (troisième icône de la barre du bas, entre Accueil et Profil) : « À l'affiche dans mes cinémas » et « La semaine prochaine » montrent des affiches de sorties, une coche corail sur celles déjà dans le journal ; toucher une affiche ouvre le formulaire pré-rempli.
- [ ] Sous chaque affiche de « À l'affiche dans mes cinémas », une petite ligne donne un cinéma, et « +N » quand le film y joue dans plusieurs ; sous le titre, « mis à jour à *H* h » une fois que le back a une passe à son actif.
- [ ] Une tuile de « À l'affiche dans mes cinémas » sans identifiant TMDB (rare) ne réagit pas au toucher et ne porte jamais la coche.
