...
- [ ] La barre du bas compte cinq icônes (Accueil, Frise, Réalisateurs, Au ciné, Profil) ; « Frise » l'ouvre.
...
- [ ] « Réalisateurs » (cinquième icône, entre Frise et Au ciné) ouvre la liste : chaque ligne montre la photo ronde (ou l'initiale), le nom, puis « N vus sur M · prochain : Titre (année) » — « … » pendant le chargement d'une filmographie, « indisponible » si elle a échoué ; liste vide : « Ajoute un réalisateur avec + ».
- [ ] Le « + » en haut à droite ouvre la recherche d'un réalisateur (clavier ouvert, résultats 400 ms après la frappe) ; toucher un résultat le suit, referme l'écran, et « Ajouté » apparaît en snackbar sur la liste.
- [ ] Toucher un réalisateur ouvre sa fiche : la filmographie dans l'ordre de sortie, note à droite des films vus, pastille corail « à voir » sur le seul premier film non vu ; toucher un film vu ouvre sa correction, toucher le prochain à voir ouvre le formulaire pré-rempli ; la poubelle en haut à droite demande confirmation puis retire le réalisateur et revient à la liste.
- [ ] Sur l'accueil, une seconde ligne « Ensuite · *Nom* » apparaît sous celle du Plex pour le réalisateur suivi qui a le plus de films vus parmi ceux qui en ont encore à voir ; absente si aucun réalisateur suivi n'a de film à voir ; toucher l'affiche ouvre le formulaire pré-rempli.
- [ ] Sur une fiche réalisateur, un appui long sur un film non vu ouvre « Marquer introuvable » / « Annuler » ; marquer le grise avec « introuvable » à droite (interrupteur désactivé) ou le fait disparaître (activé, par défaut) ; il ne porte plus jamais la pastille « à voir » ni le « Ensuite » de l'accueil.
