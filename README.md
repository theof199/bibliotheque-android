...
- [ ] Toucher une ligne de réalisateur (brief du 21 septembre 2026, « la page réalisateur ») ouvre sa page, pas la fiche ci-dessus : photo ronde, nom, dates (« 1861 – 1938 » ou « née en 1961 » selon TMDB), présentation, le bouton « Suivre »/« Suivi » ; puis sa filmographie complète (films et séries mêlés) en étagère, vus en couleur avec leur note, les autres en sépia, un coin « Plex » discret, un coin « TV » sur une série, un liseré coloré quand l'année est ouverte dans le Voyage.
