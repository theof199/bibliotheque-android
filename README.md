...
- [ ] L'accueil (25 septembre 2026, « Accueil · la porte d'entrée ») : en tête, fixe, le jour en toutes lettres (« Jeudi 24 septembre », « 1er » le premier du mois) et, à droite, « 12 films cette année » (« 1 film cette année », « Aucun film encore » à zéro), le même compte que le profil, puis le filet or — plus de titre « Journal » ni de perforations. Dessous, une grille de jaquettes sous vitre, deux colonnes, du plus récent au plus ancien : liseré or, ombre, un reflet discret en biais (pas un voile blanc), la note en pastille en bas à droite quand elle existe, pas de titre ; le reflet et l'ombre volent avec l'affiche vers la fiche. Le bouton rond corail « Ajouter un film » en bas à droite. Journal vide : la vitrine vide — un cadre pointillé avec « Ajouter un film », « La vitrine attend sa première affiche. » dessous — et pas de bouton rond ; toucher le cadre ouvre la recherche.
...
- [ ] Toucher une jaquette de l'accueil ouvre la fiche de l'entrée (25 septembre 2026, « la fiche · trois visages ») : l'affiche en grand en haut, qui vole depuis la grille et s'éteint dans le fond, le titre qui mord dessus, « TA NOTE » et le grand chiffre or penché, le réalisateur suivi d'un chevron puis l'année, « Années 1990 · Le blockbuster » dans la couleur de la décennie, les réactions en puces emoji + mot, puis « Corriger » (le formulaire pré-rempli) et « Le film » ; aucun commentaire.
...
- [ ] Toucher une ligne : la fiche de l'entrée (25 septembre 2026), puis « Corriger » : le formulaire pré-rempli, « Corriger », « Supprimer ». Corriger la note : retour à l'accueil, « Corrigé » en snackbar ; rouvrir « Mes films » : la ligne à jour.
...
- [ ] « Mes films », la recherche (24 septembre 2026) : taper « miya » trouve les films de Miyazaki par le réalisateur, « leon » trouve « Léon » ; la barre de 2 dp passe sous les puces le temps de charger tout le journal ; une recherche sans résultat dit « Rien trouvé pour « … ». » avec « Effacer », qui remet tout à zéro ; quitter l'écran et y revenir retrouve la recherche, tuer l'appli l'efface.
...
- [ ] « Au ciné » (quatrième icône de la barre du bas, entre Suivis et Profil) : « Sorti cette semaine dans mes cinémas » et « La semaine prochaine » montrent des affiches de sorties, une coche corail sur celles déjà dans le journal ; toucher une affiche ouvre le formulaire pré-rempli.
- [ ] « Sorti cette semaine dans mes cinémas » : avec un seul cinéma, son nom une fois sous le titre de section ; avec plusieurs, sous chaque affiche une petite ligne donne un cinéma, et « +N » quand le film y joue dans plusieurs ; à droite du titre, « mis à jour à *H* h » une fois que le back a une passe à son actif.
...
- [ ] « Tes séances » liste les films marqués « En salle », du plus récent au plus ancien, même ligne que « Mes films » ; toucher une ligne ouvre la fiche de l'entrée (25 septembre 2026), le glissement « Corriger » toujours la correction directement, et « N séances cette année » en tête reflète bien ce qui est journalisé.
...
- [ ] « Suivis » (cinquième icône, entre Voyage et Au ciné, ex-« Réalisateurs ») ouvre la liste : deux puces en tête, « Rétrospectives » et « Cycles » ; chaque carte montre son nom, son compte et ce qu'il reste à voir — « … » pendant le chargement de ses films, « indisponible » si elle a échoué ; puce vide : « Ajoute un réalisateur avec + » ou « Ajoute une saga avec + ».
- [ ] Changer de puce revient sur la liste déjà chargée (ou son chargement en cours), sans repartir de zéro ; quitter l'écran Suivis puis y revenir garde la puce choisie (mémorisée pour la session).
- [ ] Le bouton rond corail en bas à droite ouvre la recherche de la puce affichée (clavier ouvert, résultats 400 ms après la frappe, placeholder « Un nom de réalisateur » ou « Un nom de saga ») ; toucher un résultat le suit, referme l'écran, et « Ajouté » apparaît en snackbar sur la liste.
- [ ] Toucher une carte de cycle ouvre sa fiche : les films dans l'ordre de sortie, note à droite des films vus, pastille corail « à voir » sur le seul premier film non vu ; toucher un film vu ouvre la fiche de son entrée (25 septembre 2026 ; avant, sa correction), toucher le prochain à voir ouvre le formulaire pré-rempli ; la poubelle en haut à droite demande confirmation puis retire l'entité et revient à la liste.
- [ ] Toucher une carte de rétrospective ouvre la page du réalisateur, son pavillon (brief du 21 septembre 2026, repris le 25 septembre 2026) : le fond du monde du Voyage de l'année de son premier film, sa filmographie en grille verticale trois affiches par ligne, groupée par décennie dans l'ordre du back, longs et courts mêlés ; chaque affiche porte son titre puis son année dessous, vue en couleur avec sa note, sépia sinon, coin Plex, coin « Court » sur un court, liseré coloré quand l'année est ouverte dans le Voyage.
- [ ] Sur cette page, toucher une affiche dont le film est dans le Voyage ouvre sa fiche du Voyage ; une autre ouvre une fiche simple, sur le fond du monde de sa décennie : l'affiche en grand en haut, le titre, le réalisateur à chevron et l'année, « Années 1990 · Le blockbuster », « TA NOTE » si vu ; sur un film vu dont l'entrée est retrouvée dans le journal, ses réactions en puces et « Corriger » (le formulaire de correction) ; puis « Je l'ai vu », « Voir sur le Plex », « Demander sur Sir », « Introuvable »/son inverse, « Le film » en dernier au filet or — une série n'a ni « Je l'ai vu » ni formulaire, et plus aucune ligne à la place (« Les séries se suivent dans Suivis » retirée le 25 septembre 2026).
...
- [ ] Suivis, l'en-tête et les puces (25 septembre 2026) : « Suivis » à gauche, « 5 rétrospectives · 2 cycles » à droite (accordé, « 1 rétrospective · 0 cycle »), absent un instant au chargement puis juste, jamais un « 0 » qui grimpe ; le filet or dessous ; les puces « Rétrospectives » et « Cycles », l'active en or ; plus de « + » en haut, le bouton rond corail en bas à droite ne couvre jamais la dernière carte.
- [ ] Suivis, la carte d'une rétrospective : portrait liseré d'or, nom, « 4 sur 12 · vu il y a 3 jours » (ou « ajouté le … » sans film vu), « 4/12 » à droite, la barre or, puis « ENSUITE » en or au-dessus du titre et de l'année du prochain film, son affiche 40 × 60 liserée ; la carte la plus récemment active en haut — voir un film d'un réalisateur du bas le fait remonter en tête au retour ; une rétrospective toute vue (ou perdue) descend sous « RÉTROSPECTIVES COMPLÈTES », à 85 %, « 6/6 » en or, « bouclée le … », le sceau sur le portrait, sans « Ensuite ».
- [ ] Suivis, la bande d'un cycle : les vraies affiches en rangée, l'année dessous ; les vues en couleur avec une pastille or cochée, le prochain liseré de corail avec son année en corail, les suivantes désaturées et atténuées (jamais un cadre vide) ; une saga de plus de six films passe à la ligne, six par rangée ; trois films n'occupent que la moitié gauche ; « Masquer les introuvables » coupé sur la fiche d'une saga, ses introuvables reviennent dans la bande avec le tampon « PERDU » et le compte « 3/6 » les compte ; rétabli, ils disparaissent et le total baisse d'autant. Sur la fiche de la saga, le filet or sous le nom et des affiches 40 × 60 liserées.
- [ ] Le pavillon d'un réalisateur, l'en-tête : un dégradé de la couleur de son monde en haut, qui remonte avec l'en-tête en défilant ; portrait liseré à gauche, le nom en blanc (plus dans l'accent), ses dates, « RÉTROSPECTIVE · 4 SUR 12 » en or, « 3 sur le Plex » (« 0 sur le Plex » écrit), la barre or ; deux boutons côte à côte : « Suivre » (gris) ou « Suivi »/« Suivie » (or, coché) selon le réalisateur ou la réalisatrice, et « Lire la biographie », qui la déplie puis « Replier la biographie » la replie — repliée à chaque arrivée, française comme anglaise ; sans biographie, « Suivre » seul sur toute la rangée ; l'interrupteur « Masquer les introuvables » dessous.
- [ ] Le pavillon, les décennies et la case « ENSUITE » : chaque décennie titrée « 1990 » puis « LE BLOCKBUSTER » dans sa couleur, « 2 sur 4 » à droite (qui change quand on bascule « Masquer les introuvables » sur une décennie qui en a), un filet de sa couleur sur toute la largeur ; le premier film ni vu ni introuvable de toute la filmographie porte un liseré corail et « ENSUITE » en corail lisible en haut à gauche — une seule case sur la page, aucune quand tout est vu ; si c'est un court, « Court » passe en haut à droite, sous le badge Plex ; les non-vus un peu plus effacés qu'avant ; taille de police au maximum : les deux boutons et l'en-tête de décennie restent lisibles, rien de coupé.
...
- [ ] Toucher une affiche ouvre sa fiche, reprise le 25 septembre 2026 : l'affiche en grand en haut, le titre, le réalisateur à chevron, « Salle · *nom* » penché dans l'accent du monde, la raison sous un filet vertical, « TA NOTE » et les réactions en puces si vu (plus de commentaire), un programme avec « PROGRAMME · 2 h 03 » puis ses bobines (pastille or cochée si vue, petit badge Plex sinon), et selon l'état « Corriger » (film vu, le formulaire de correction), « Voir sur le Plex » (absent sans lien), « Je l'ai vu », « Demander sur Sir » (passe à « demandé »), « Introuvable » (en texte gris) ou « Le remettre à voir », puis « Le film » en dernier, au filet or. Une année verrouillée montre le carton « Prochainement », sans affiche.
...
- [ ] Enregistrer un film : une fois le clap joué, la feuille du carton s'ouvre d'elle-même (« la feuille de lecture · le chroniqueur », 25 septembre 2026) — « LE FILM » au-dessus du titre, l'année dessous ; « Le chroniqueur écrit… » se tape à la machine devant un curseur clignotant tant que le carton s'écrit, puis le début du texte se tape et le reste se pose d'un coup, en Fraunces, paragraphe par paragraphe ; au pied, « LE CHRONIQUEUR » et « FEUILLE N° *n* », qui ne défilent pas avec le texte ; la fermer d'un geste. « Le film », sur une fiche ou en bas de la correction, rouvre la même feuille ; si le carton ne vient pas, « Le chroniqueur n’a pas fini. Reviens plus tard. », sans bouton.
- [ ] Animations coupées dans les réglages du téléphone : toute feuille de lecture (le film, une salle, l'ouverture, le générique) pose son texte d'un coup, sans machine à écrire ni curseur.
...
- [ ] Sur l'accueil, la carte « Ce soir » (25 septembre 2026) apparaît au-dessus d'« Ensuite » tant qu'une séance est prise : l'affiche du long, « CE SOIR », le titre du long, « + *Court* · court » s'il y en a un, « VOYAGE *1962* » ; toucher la carte ouvre la fiche de l'année ; noter le long comme vu la fait disparaître au prochain passage sur l'accueil.
