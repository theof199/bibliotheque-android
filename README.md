...
- [ ] « Mes films », le glissement : glisser une ligne vers la gauche découvre « Corriger » (or) et « Supprimer » (ambre), avec une petite vibration à l'ouverture ; en ouvrir une autre referme la première, défiler aussi ; « Corriger » ouvre le formulaire, « Supprimer » demande « Supprimer ce visionnage ? » puis retire la ligne ; « Tes séances » d'« Au ciné » garde ses emojis et ne glisse pas.
