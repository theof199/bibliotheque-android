...
- [ ] « Autre long »/« Autre court » ouvre une feuille sans attente (candidats déjà chargés, groupés par salle) ; choisir un candidat met la carte à jour tout de suite. « Prendre » étiquette la carte « Prise » et fait apparaître « Voir sur le Plex »/« Demander sur Sir » et « Je l'ai vu » sur chaque film ; « Ignorer » fait disparaître la carte.
